...
class ManageSecurityActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_manage_security)
        //Exiting page
        ...
        adapter = CustomAdapter(this@ManageSecurityActivity, userArrayList)
        ...
        dbRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()){
                    ...
                    var adapter = CustomAdapter(this@ManageSecurityActivity,userArrayList)
                    ...
                    adapter.setOnItemClickListener(object : CustomAdapter.onItemClickListener {
                        override fun onItemClick(position: Int) {
                            ...
                            val intent = Intent(this@ManageSecurityActivity, SecurityTabsActivity::class.java)

                            //put Extra data

                            val clickedSecurityGroup = userArrayList[position]
                            intent.putExtra("rent_name", clickedSecurityGroup.groupName)
